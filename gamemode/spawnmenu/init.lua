...
AddCSLuaFile( "fortwars/gamemode/spawnmenu/creationmenu/content/contenttypes/fw_entities.lua" )
AddCSLuaFile( "fortwars/gamemode/spawnmenu/creationmenu/content/contenttypes/fw_props.lua" )